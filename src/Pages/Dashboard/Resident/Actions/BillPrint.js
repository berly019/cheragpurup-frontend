...
function BillPrint(props) {
  const { pMainData, f_year } = useContext(DataContext);
  ...
  const fetchWordData = (wordData) => {
    axios
      .get(`${process.env.REACT_APP_BASE_URL}/up/resident/word/${wordData}/year/${f_year}`)
      .then((data) => {
  ...
  const handleRange = () => {
    if (
      ...
      ranges === 0 ||
      rangee === 0 ||
      ranges > wordData.length ||
      rangee > wordData.length
    ) {
  ...
  return (
    ...
    >
      ...
      <Modal.Body className="px-5 text-center">
        <Row xs={1}>
          <Col>
            <p className="fs-4 border-bottom fw-bold">
              ...
              {dataCount > 0 ? (
                <>
                  ...
                  <Button variant="success" onClick={handlePrint}>
                    সব ডাটা প্রিন্ট করুন
                  </Button>
                  <div className="d-none">
                    <div
                      ref={componentRef}
                      className="billPrint  print-landscape-a4"
                    >
                          ...
                          >
                            <Col className="py-3 px-5" key={data._id}>
                              ...
                              <div className="text-center mt-2">
                                <p className="mb-0">
                                  নিয়মিত ইউপি কর পরিশোধ করুন। ইউনিয়নের উন্নয়নে
                                  অংশগ্রহন করুন।
                                </p>
                                <p style={{ fontSize: "14px" }}>
                                  ইউনিয়ন পরিষদের সকল পরিসেবা গ্রহনকালে উক্ত বইল
                                  পরিশধের ফটোকপি সংযুক্ত করতে হবে
                                </p>
                              </div>
                            </Col>
                  ...
                  <div className="my-5">
                    <p className="fs-4 fw-bold border-bottom">
                      ডাটা রেঞ্জ সিলেক্ট করুন
                    </p>
                    <Form.Group
                      as={Col}
                    ...
                    >
                      <Col className="me-2">
                        <Form.Control
                          type="number"
                          onBlur={(e) => setRanges(e.target.value)}
                          placeholder="শুরু নং"
                        />
                      </Col>
                      <Col>
                        <Form.Control
                          type="number"
                          onBlur={(e) => setRangee(e.target.value)}
                          placeholder="শেষ নং"
                        />
                      </Col>
                    </Form.Group>
                    ...
                    {rangeData.length > 0 ? (
                      <>
                        ...
                        <Button variant="success" onClick={handleRangePrint}>
                          {rangeData.length} টি ডাটা প্রিন্ট করুন
                        </Button>
                        <div className="d-none">
                          <div
                            ref={componentRangeRef}
                            className="billPrint  print-landscape-a4"
                          >
                              ...
                              (data) => (
                                ...
                                >
                                  <Col className="py-3 px-5" key={data._id}>
                                    ...
                                    <div className="text-center mt-2">
                                      <p className="mb-0">
                                        নিয়মিত ইউপি কর পরিশোধ করুন। ইউনিয়নের
                                        উন্নয়নে অংশগ্রহন করুন।
                                      </p>
                                      <p style={{ fontSize: "14px" }}>
                                        ইউনিয়ন পরিষদের সকল পরিসেবা গ্রহনকালে
                                        উক্ত বইল পরিশধের ফটোকপি সংযুক্ত করতে হবে
                                      </p>
                                    </div>
                                  </Col>

        ...
        <>
            ...
            <div ref={componentRef} className="border m-2 p-3" key={data?._id}>
                <div className="text-center">
                    ...
                    <p className="mb-1">উপজেলা:- {myArray[0]} জেলা:- {myArray[1]}</p>
                ...
                <div className="py-2 my-3">
                    ...
                    <p style={{ textAlign: 'justify' }}>
                        এই মর্মে ওয়ারিশ সনদপত্র প্রদান করা যাইতেছে যে {data?.applicant_name}, পিতা/স্বামী {data?.guardian_name}, মাতা {data?.mother_name}, গ্রাম {data?.village} , ওয়ার্ড নং {data?.word_no} পোস্ট অফিস {data?.post_office} , উপজেলা:- {myArray[0]} জেলা:- {myArray[1]}; কে আমি ব্যক্তিগতভাবে চিনি ও জানি। তিনি বাংলাদেশের নাগরিক ও অত্র ইউনিয়নের স্থায়ী বাসিন্দা। তিনি মৃত্যুকালে নিম্ন বর্ণিত ওয়ারিশ রাখিয়া যান।
                    </p>
                    ...
                    <p>
                        উল্লেখিত ওয়ারিশ ছাড়া তাহার আর কোন ওয়ারিশ নাই। ইহা আমার জানামতে সত্য। এই তথ্য {pMainData?.name} ইউপি সদস্য জনাব/জনাবা {data?.marital_status} দ্বারা সত্যায়িত।
                    </p>
                </div>

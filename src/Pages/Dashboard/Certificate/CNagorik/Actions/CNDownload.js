...
const CNDownload = ({ data }) => {
    ...
    const handlePrint = useReactToPrint({
        documentTitle: `নাগরিক সনদপত্র ${data?.memorandum_no}`,
        ...
        <>
            ...
            <div ref={componentRef} className="border m-2 p-3" key={data?._id}>
                <div className="text-center">
                    ...
                    <p>উপজেলা:- {myArray[0]} জেলা:- {myArray[1]}</p>
                    <p className="text-danger mx-auto fs-4 fw-bold mb-0 px-4" style={{ border: "2px solid black", borderRadius: "10px", width: "fit-content" }}>নাগরিক সনদপত্র</p>
                </div>
                <div className="py-2 snood-logo my-3">
                    ...
                    <p style={{ textAlign: 'justify' }}>
                        এই মর্মে নাগরিক সনদপত্র প্রদান করা যাইতেছে যে {data?.applicant_name} , ({data?.marital_status}) , পিতা/স্বামী {data?.guardian_name}, মাতা {data?.mother_name}, গ্রাম {data?.village} , ওয়ার্ড নং {data?.word_no} পোস্ট অফিস {data?.post_office} , উপজেলা:- {myArray[0]} জেলা:- {myArray[1]}; কে আমি ব্যক্তিগতভাবে চিনি ও জানি। তিনি বাংলাদেশের নাগরিক ও অত্র ইউনিয়নের স্থায়ী বাসিন্দা। আমার জানামতে তিনি সমাজ ও রাষ্ট্রবিরোধী কোন খারাপ কাজে জড়িত নন। আমি তাঁহার সার্বিক মঙ্গল কামনা করতেছি।
                    </p>
                    <p>

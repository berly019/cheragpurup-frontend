            ...
            <div ref={componentRef} className="border m-2 p-3" key={data?._id}>
                ...
                <div className="py-2 snood-logo my-3">
                    ...
                    <p style={{ textAlign: 'justify' }}>
                        এই মর্মে নাগরিক সনদপত্র প্রদান করা যাইতেছে যে {data?.applicant_name} , ({data?.marital_status}) , পিতা/স্বামী {data?.guardian_name}, মাতা {data?.mother_name}, গ্রাম {data?.village} , ওয়ার্ড নং {data?.word_no} পোস্ট অফিস {data?.post_office} , উপজেলা:- আলমডাঙ্গা; জেলা:- চুয়াডাঙ্গা; কে আমি ব্যক্তিগতভাবে চিনি ও জানি। তিনি বাংলাদেশের নাগরিক ও অত্র ইউনিয়নের স্থায়ী বাসিন্দা। আমার জানামতে তিনি সমাজ ও রাষ্ট্রবিরোধী কোন খারাপ কাজে জড়িত নন। আমি তাঁহার সার্বিক মঙ্গল কামনা করতেছি।
                    </p>
                    <p>

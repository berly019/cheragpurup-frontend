...
import CSModalEdit from './Actions/CSModalEdit';
import CSModalShow from './Actions/CSModalShow';
    ...
    React.useEffect(() => {
        ...
        if (word === "all") {
            async function fetchData() {
                let data = await axios.get(`${process.env.REACT_APP_BASE_URL}/up/commerce`)
            ...
            axios.get(`${process.env.REACT_APP_BASE_URL}/up/commerce/word/${word ? word : 1}`)
                .then(data => {
                    setFilteredData(data.data)
                    setFilteredDataTwo(data.data)
                    setIsLoading(true)
        ...
        <Container>
            ...
            <Row>
                <div className='d-flex flex-column flex-sm-row justify-content-between align-items-center'>
                    ...
                    <div>
                        <Button className="mt-3 mt-sm-0 me-2" variant="success" onClick={() => setBillPrint(true)} size="sm"><HiOutlinePlusCircle /> বিল প্রিন্ট</Button>
            ...
            <Row className="overflow-auto px-2 px-md-0 py-3">
                <table ref={formRef} className="table table-striped table-hover fs-6 text-center">

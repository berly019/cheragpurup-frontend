...
const CSModalAdd = () => {
    const { addCommerce } = useContext(DataContext);
    ...
    const handleSubmit = (e) => {
        ...
        fetch(`${process.env.REACT_APP_BASE_URL}/up/commerce`, {
            method: 'post',
            headers: {
            ...
            .then(data => {
                // console.log(data)
                // setData(data?.data)
                addCommerce(holding_no, payer_name, guardian_name, business_org, word_no, village, previes_areas_tax, assign_tax, collected_tax, mobile_no, total_tax, areas_tax);
            })
    }
            ...
            <Row xs={1} lg={2}>
                <Col>
                    <Form.Group as={Col} className="mb-3 d-flex flex-column flex-sm-row" >
                        ...
                        <Col sm="8">
                            <Form.Control type="number" onChange={(e) => setHoldingNo(e.target.value)} required />
                        </Col>
                    </Form.Group>
                    <Form.Group as={Col} className="mb-3 d-flex flex-column flex-sm-row" >
                        <Form.Label column sm="4">
                        ...
                        <Col sm="8">
                            <Form.Control type="text" onChange={(e) => setPayerName(e.target.value)} required />
                        </Col>
                    </Form.Group>
                    <Form.Group as={Col} className="mb-3 d-flex flex-column flex-sm-row" >
                        <Form.Label column sm="4">
                        ...
                        <Col sm="8">
                            <Form.Control type="text" onChange={(e) => setGuardianName(e.target.value)} required />
                        </Col>
                    </Form.Group>
                    <Form.Group as={Col} className="mb-3 d-flex flex-column flex-sm-row" >
                        <Form.Label column sm="4">
                        ...
                        <Col sm="8">
                            <Form.Control type="text" onChange={(e) => setBusinessOrg(e.target.value)} />
                        </Col>
                    </Form.Group>
                    <Form.Group as={Col} className="mb-3 d-flex flex-column flex-sm-row" >
                        <Form.Label column sm="4">
                        ...
                        <Col sm="8">
                            <Form.Control type="number" onChange={(e) => setWordNo(e.target.value)} required />
                        </Col>
                    </Form.Group>
                    <Form.Group as={Col} className="mb-3 d-flex flex-column flex-sm-row" >
                        <Form.Label column sm="4">
                        ...
                        <Col sm="8">
                            <Form.Control type="text" onChange={(e) => setVillage(e.target.value)} require />
                        </Col>
                    </Form.Group>
                </Col>
                <Col>

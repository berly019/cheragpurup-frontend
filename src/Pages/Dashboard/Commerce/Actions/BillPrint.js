...
function BillPrint(props) {
    ...
    const fetchWordData = (wordData) => {
        axios.get(`${process.env.REACT_APP_BASE_URL}/up/commerce/word/${wordData}/year/${f_year}`)
            .then(data => {
                            ...
                            {dataCount > 0 ?
                                <>
                                    ...
                                    <div className="d-none">
                                        <div ref={componentRef} className="billPrint">
                                            {/* <Table striped hover id='allData'>
                                                <thead>
                                                    <tr>
                                                        <th>#</th>
                                                        <th>কর দাতার নাম</th>
                                            ...
                                            {wordData?.map(data =>
                                                <Row key={data._id} style={{ height: "100vh", width: "100vw" }}>
                                                    <Col className="py-3 px-5" key={data._id}>
                                                        <Row xs="auto" className="text-center justify-content-between">
                                    ...
                                    <div className="my-5">
                                        ...
                                        {rangeData.length > 0 ?
                                            <>
                                                ...
                                                <div className="d-none">
                                                    <div ref={componentRangeRef} className="billPrint">

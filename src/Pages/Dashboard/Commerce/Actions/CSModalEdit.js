...
const CSModalEdit = ({ modalData }) => {
    const { updateCommerce } = useContext(DataContext);
    ...
    const updatedCommerce = { id, holdingNo, payerName, guardianName, businessOrg, wordNo, village, pAreasTax, assignTax, collectedTax, mobileNo, totalTax, areasTax, dTotalTax }
            ...
            <Row xs={1} lg={2}>
                <Col>
                    <Form.Group as={Col} className="mb-3 d-flex flex-column flex-sm-row" >
                        ...
                        <Col sm="8">
                            <Form.Control type="number" defaultValue={holdingNo} onChange={(e) => setHoldingNo(e.target.value)} />
                        </Col>
                    </Form.Group>
                    <Form.Group as={Col} className="mb-3 d-flex flex-column flex-sm-row" >
                        <Form.Label column sm="4">
                        ...
                        <Col sm="8">
                            <Form.Control type="text" defaultValue={payerName} onChange={(e) => setPayerName(e.target.value)} />
                        </Col>
                    </Form.Group>
                    <Form.Group as={Col} className="mb-3 d-flex flex-column flex-sm-row" >
                        <Form.Label column sm="4">
                        ...
                        <Col sm="8">
                            <Form.Control type="text" defaultValue={guardianName} onChange={(e) => setGuardianName(e.target.value)} />
                        </Col>
                    </Form.Group>
                    <Form.Group as={Col} className="mb-3 d-flex flex-column flex-sm-row" >
                        <Form.Label column sm="4">
                        ...
                        <Col sm="8">
                            <Form.Control type="text" defaultValue={businessOrg} onChange={(e) => setBusinessOrg(e.target.value)} />
                        </Col>
                    </Form.Group>
                    <Form.Group as={Col} className="mb-3 d-flex flex-column flex-sm-row" >
                        <Form.Label column sm="4">
                        ...
                        <Col sm="8">
                            <Form.Control type="number" defaultValue={wordNo} onChange={(e) => setWordNo(e.target.value)} />
                        </Col>
                    </Form.Group>
                ...
                <Col>
                    <Form.Group as={Col} className="mb-3 d-flex flex-column flex-sm-row"  >
                        ...
                        <Col sm="8">
                            <Form.Control type="number" title={data?.previes_areas_tax} defaultValue={pAreasTax} onBlur={(e) => setPAreasTax(e.target.value)} />
                        </Col>
                    </Form.Group>
                    <Form.Group as={Col} className="mb-3 d-flex flex-column flex-sm-row" >
                        ...
                        <Col sm="8" lg="8">
                            <Form.Control type="number" title={data?.assign_tax} defaultValue={assignTax} onBlur={(e) => setAssignTax(e.target.value)} />
                        </Col>
                    </Form.Group>
                    <Form.Group as={Col} className="mb-3 d-flex flex-column flex-sm-row" >
                        <Form.Label column sm="4">
                        ...
                        <Col sm="8">
                            <Form.Control type="number" title={data?.total_tax} value={totalTax ? totalTax : data?.total_tax} disabled />
                        </Col>
                    </Form.Group>
                    <Form.Group as={Col} className="mb-3 d-flex flex-column flex-sm-row" >
                        <Form.Label column sm="4">
                        ...
                        <Col sm="8">
                            <Form.Control type="number" title={data?.collected_tax} defaultValue={collectedTax} onBlur={(e) => setCollectedTax(e.target.value)} />
                        </Col>
                    </Form.Group>
                    ...
                    <Form.Group as={Col} className="mb-3 d-flex flex-column flex-sm-row" >
                        ...
                        <Col sm="8">
                            <Form.Control type="number" title={data?.areas_tax} value={areasTax ? areasTax : data?.areas_tax} disabled />
                        </Col>
                    </Form.Group>
                    <Form.Group as={Col} className="mb-3 d-flex flex-column flex-sm-row" >
                        <Form.Label column sm="4">
                        ...
                        <Col sm="8">
                            <Form.Control title="Type number without code 0" type="number" defaultValue={mobileNo} onChange={(e) => setMobileNo(e.target.value)} />
                        </Col>
                    </Form.Group>
                </Col>
            </Row>

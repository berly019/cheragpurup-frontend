      ...
      >
        <Row className="text-center justify-content-between align-items-center">
          ...
          <Col>
            ...
            <p
              className="text-danger mx-auto fs-4 fw-bold px-4 my-2"
              style={{
          ...
          <Col xs="auto">
            <p
              className="text-danger fs-5 mb-0"
        ...
        <div className="py-2 my-3">
          ...
          <div className="snood-logo snood-logo2">
            ...
            <Row className="justify-content-between">
              ...
              <Col>
                <p className="pb-0 border-bt">{data?.guardian_name}</p>
              </Col>
              <Col xs="auto">
                <p>মাতাঃ</p>
              </Col>
              <Col>
                <p className="pb-0 border-bt">{data?.mothers_name}</p>
              </Col>
            </Row>
            <Row className="justify-content-between">
              <Col xs="auto">
              ...
              <Col>
                <p className="pb-0 border-bt">{data?.address}</p>
              </Col>
              <Col xs="auto">
                <p>ব্যবসা প্রতিষ্ঠানের ঠিকনাঃ </p>
              </Col>
              <Col>
                <p className="pb-0 border-bt">{data?.institute_address}</p>
              </Col>
            </Row>
            <Row className="justify-content-between">
              <Col xs="auto">
              ...
              <Col>
                <p className="pb-0 border-bt">{data?.profession_capital}</p>
              </Col>
              <Col xs="auto">
                <p>টাকাঃ</p>
              </Col>
              ...
              <Col>
                <p className="pb-0 border-bt">{data?.mobile_no}</p>
              </Col>
            </Row>
            <Row className="mt-3">
              <p>ফি ও করের পরিমাণঃ</p>
            </Row>
            <Row className="justify-content-between align-items-center">
              ...
              <Col xs={2}>
                <p className="pb-0 border-bt">{data?.license_fee} </p>
              </Col>
              <Col xs={2}>
                <p>টাকা</p>
              </Col>
            ...
            <div className="text-center mt-3 p-2 border">
              <span>
                বৈধতার মেয়াদ ১লা জুলাই ২০২২ ইং হইতে ৩০শে জুন ২০২৩ ইং তারিখ
                পর্যন্ত।
              </span>
              <p className="mb-0">
                উপরিউক্ত ফি ও কর প্রাপ্ত হয়ে{" "}
                {pMainData?.name
                  ?.split(" ")
                  ?.reverse()
                  ?.slice(1)
                  ?.reverse()
                  ?.join(" ")}{" "}
                সীমানায় তাঁর ব্যবসা/বৃত্তি/পেশা চালিয়ে যাওয়ার জন্য এই লাইসেন্স
                প্রদান করা হল।
              </p>
            </div>
          </div>

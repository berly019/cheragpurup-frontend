...
const WMemberEdit = ({ data }) => {
    const id = data._id;
    const { updateWMember } = useContext(DataContext);
    ...
    const updatedWM = { id, desi, name, phone, email, doj, image }
    ...
    return (
        ...
        <Form ref={formRef} onSubmit={handleSubmit} className="py-5 border-top">
            ...
            <Col className="text-end pt-3">
                ...
                <Button className="ms-3" type="submit" variant="success">Update</Button>
            </Col>
        </Form>

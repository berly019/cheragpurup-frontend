...
const Profile = () => {
    ...
    const handleImageSubmit = (e) => {
        ...
        fetch(`https://khadimpur-mongoose-backend.herokuapp.com/up/db_user/edit/image/${id}`, {
            method: 'PUT',
            body: formData
        })
            .then(res => res.json())
    ...
    const onSubmit = data => {
        axios.put(`https://khadimpur-mongoose-backend.herokuapp.com/up/db_user/edit/profile/${id}`, data)
            .then(res => {
                if (res.data) {
                    setSuccess(true)
                }

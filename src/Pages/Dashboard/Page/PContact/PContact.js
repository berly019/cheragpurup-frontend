...
import { Button, Col, Container, Form, Image, Row, Spinner, Modal, Alert } from 'react-bootstrap';
...
const PContact = () => {
    ...
    const { isLoading, pContactData } = useContext(DataContext);
    ...
    return (
        <Container>
            ...
            <div key={pContactData._id}>
                <div>
                    <Col className="text-end" style={{ cursor: 'pointer' }}>
                        {/* <GoDiffAdded onClick={() => setModalShow(true)} />  */}
                        <Button variant="success" onClick={() => { handleShowE(); setModalEData(pContactData) }} size="sm"><FiEdit /> Edit</Button>
                    ...
                    <Row className="border p-3 rounded-3" md={2}>
                        <Col md={8} className="d-flex flex-column flex-md-row">
                            <Image src={pContactData?.image} fluid style={{ width: '216px', height: '132px' }} />
                        ...
                        <Col md={8}>
                            <Form>
                                <Form.Group as={Col} className="mb-3 d-flex flex-column flex-sm-row" controlId="formPlaintextPassword">
                                    ...
                                    <Col sm="8">
                                        <Form.Control type="text" defaultValue={pContactData?.name} disabled />
                                    </Col>
                                </Form.Group>
                                <Form.Group as={Col} className="mb-3 d-flex flex-column flex-sm-row" controlId="formPlaintextPassword">
                                    <Form.Label column sm="4">
                                    ...
                                    <Col sm="8">
                                        <Form.Control type="text" defaultValue={pContactData?.location} disabled />
                                    </Col>
                                </Form.Group>
                            </Form>
                        </Col>

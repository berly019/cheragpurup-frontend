                    ...
                    <Row xs={1}>
                        <Form onSubmit={handleSubmit} className="py-5 border-top">
                            ...
                            <Form.Group as={Row} className="mb-3" controlId="formHorizontalEmail">
                                ...
                                <Col sm={10}>
                                    <Form.Control type="text" defaultValue={data?.name} onChange={(e) => setName(e.target.value)} required />
                                </Col>
                            </Form.Group>
                            <Form.Group as={Row} className="mb-3" controlId="formHorizontalPassword">
                                <Form.Label column sm={2}>
                                ...
                                <Col sm={10}>
                                    <Form.Control type="text" defaultValue={data?.location} onChange={(e) => setLocation(e.target.value)} required />
                                </Col>
                            </Form.Group>

...
const Banner = () => {
    ...
    const {pCommerceData} = useContext(DataContext);
    
    const bg = pCommerceData?.image;
    const bg4 = {
            ...
            <div className='bg-content'>
                <Container className="p-md-5 text-center">
                    <Row xs="auto" md={2} className="align-items-center justify-content-center">
                        <Col>
                            <p className="fs-1 fw-bold">{pCommerceData?.name}</p>
                            <p className="fs-2">{pCommerceData?.location}</p>
                        </Col>
                    </Row>
                </Container>
            </div>

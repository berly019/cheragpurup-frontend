    ...
    return (
        <Container className="py-5">
            <div className="text-center pt-5">
                <p className="fs-2 fw-bold m-0">খাদিমপুর ইউনিয়ন পরিষদ</p>
                                ...
                                <Card.Body className="px-4 d-lg-flex justify-content-evenly align-items-center fs-5">
                                    <div className="d-flex flex-column justify-content-center align-items-center">
                                        ...
                                        <div className="position-relative">
                                            ...
                                            <div className="text-center px-5 py-1 position-relative btn-style" style={{ backgroundColor: '#FFCE00', bottom: '25px' }}>
                                ...
                                <Card.Body className="px-4">
                                    <div className="d-flex flex-column justify-content-center align-items-center">
                                        ...
                                        <div className="position-relative">
                                            ...
                                            <div className="text-center px-5 py-1 position-relative" style={{ backgroundColor: '#FFCE00', bottom: '15px' }}>
